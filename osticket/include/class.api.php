...
class ApiController {
    ...
    function getAttachId(){
        $this->attachId=$_SERVER['HTTP_ATTACHMENTID'];
        return $this->attachId;
    }
    //by letuan
    function getTask(){ 
        $this->taskclient=$_SERVER['HTTP_TASK'];
        return $this->taskclient;
    }
    
    //   by letuan
    function getStatus(){ 
        $this->status=$_SERVER['HTTP_STATUS'];
        return $this->status;
    }
    //by letuan
    function getIdClient(){
        $this->idclient=$_SERVER['HTTP_IDCLIENT'];
        return $this->idclient;
    }
    //by letuan
    function getEmailClient(){
        $this->emailclient=$_SERVER['HTTP_EMAILCLIENT'];
        return $this->emailclient;
    }
    //by letuan
    function getFormatClient(){
        $this->formatclient=$_SERVER['HTTP_FORMAT'];        
