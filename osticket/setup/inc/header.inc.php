...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?bba9ccc">
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?bba9ccc"></script>
    <script type="text/javascript" src="js/tips.js?bba9ccc"></script>
    <script type="text/javascript" src="js/setup.js?bba9ccc"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
